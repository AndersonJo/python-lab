...
import numpy as np
from yourtest import matrix_add, matrix_multiply
...
class MatrixTest(TestCase):
    ...
    def test_scalar_multiplication(self):
        ...
        self.assertEqual(True, (a * 3 == matrix_multiply(self.data1, 3)).all())
        self.assertEqual(True, (b * -1 == matrix_multiply(self.data2, -1)).all())
        self.assertEqual(True, (c * 0 == matrix_multiply(self.data3, 0)).all())
        self.assertEqual(True, (d * 0.4 == matrix_multiply(0.4, self.data4)).all())
